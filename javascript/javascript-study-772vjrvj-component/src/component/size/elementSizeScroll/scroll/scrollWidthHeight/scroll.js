...
//getScrollbarWidth() 이걸 안쓰면
const containerStyle = window.getComputedStyle(container);
const borderFull = containerStyle.getPropertyValue('border');
const borderPxIdx = borderFull.indexOf('px');
const borderPx = borderFull.substring(0, borderPxIdx);
const scrollWidth = container.offsetWidth - (borderPx * 2) - container.clientWidth;
